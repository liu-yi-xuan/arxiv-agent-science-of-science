# 📚 AI Agents x Science of Science
...
> **Why these two fields belong together:** AI agents are transforming how science is done — automating literature review, generating hypotheses, running experiments, and writing papers. At the same time, Science of Science provides the quantitative lens to understand how the agent research revolution itself unfolds — tracking knowledge diffusion, measuring impact, and mapping collaboration. They form a feedback loop: agents accelerate science, and science of science helps us build better agents.

This repo auto-updates daily from ArXiv, tracking papers at the intersection of AI agents and the scientific research process.
...
|----------|-------------|
| 🔬 **AI Agents for Scientific Discovery** | Agents that do science — hypothesis generation, experiment design, lab automation, drug discovery, mathematical reasoning |
| 📖 **Research Workflow Agents** | Agents for literature review, paper writing, peer review assistance, knowledge extraction, and research summarization |
| 🧠 **Multi-Agent Scientific Collaboration** | Multi-agent systems that simulate or enhance research teams, collaborative discovery, and scientific debate |
| 📊 **Computational Science of Science** | Studying research computationally — citation dynamics, knowledge diffusion, research trends, scientometrics, impact prediction |
| 🛠️ **Benchmarks & Evaluation for Research Agents** | Measuring agent capabilities in scientific/research contexts, reproducibility, and research quality assessment |
...
| [The Era by Eon Benchmark: A Generated Enterprise Estate with Exact Ground Truth for Benchmarking LLM Agents](http://arxiv.org/abs/2609.09853v1) | Benjamin Gruenbaum, Doron Porat, Assaf Natanzon et al. | LLM agents for enterprise systems of record cannot be evaluated on customer production data, and no existing substitute provides ground truth. |
| [LexAgentHallu: A Hierarchical Benchmark for Profiling Hallucinations in Legal Agents](http://arxiv.org/abs/2609.09754v1) | Yujin Zhou, Mingxuan Zheng, Chuxue Cao et al. | As large language models are increasingly deployed as tool-augmented legal agents, they introduce agentic hallucinations where tool-call and reasoning errors cascade into fabricated holdings and mi... |
...
| Title | Authors | TLDR |
|-------|---------|------|
| [COGTRL: Training LLMs for Scientific Discovery Assistance using Cognitive Traces via Reinforcement Learning](http://arxiv.org/abs/2608.30109v1) | Shrinidhi Kumbhar Santosh Mashetty Divij Handa Kevin Coutinho, Siddharth Sambhaji Ghule, Chitta Baral | Large Language Models (LLMs) trained on extensive scientific research are increasingly integrated as assistants for scientific discovery. |
| [Dr. Claw: An AI Scientist Workspace for Vibe Research](http://arxiv.org/abs/2609.00365v1) | Dingjie Song, Hanrong Zhang, Dawei Liu et al. | Command-line coding agents (e.g., Claude Code, Gemini CLI) can already read and write files and sustain long sessions, yet end-to-end research still fragments across chat tools, IDEs, terminals, an... |
...
|-------|---------|------|
| [Polished but Unresolved: Identifying Late-Stage Pressure States in Long-Horizon Tool-Use Agents](http://arxiv.org/abs/2609.00823v1) | Haoyang Chen, Yi Liu, Jianzhi Shao et al. | Long-horizon tool-use agents need not only to search and plan, but also to decide when to finalize. We study late-stage pressure states, in which an agent is biased toward submitting a final answer... |
| [Will the User Ever Know? Covert Indirect Prompt Injection Attacks on Tool-Using LLM Agents](http://arxiv.org/abs/2608.30362v2) | Yunseok Lee, Yunji Kim, Woojin Lee | As LLM agents take real-world actions through tools, indirect prompt injection (IPI) has emerged as a serious threat. |
| [Selective Agent Guidance via Entropy: Learning Autonomous Policies from Imperfect VLM Teachers](http://arxiv.org/abs/2609.01567v1) | Matteo Merler, Giovanni Bonetta, Davide Zago et al. | Vision-Language Models (VLMs) provide useful priors for interactive decision-making, but using them directly as policies is expensive and brittle: they must be queried at every step, do not improve... |
| [E-Commerce Bench: Evaluating LLM Agents on Long-Horizon Autonomous Business Operation](http://arxiv.org/abs/2608.30730v1) | Wei Fan, Xinjie Shen, Xudong Guo et al. | Long-horizon agentic tasks go beyond chaining short tasks over more interaction turns. Their evolving dynamic environments and long-range dependencies require Large Language Models (LLMs) to contin... |
| [EvoSkill Injection: Red-Teaming Autonomous Skill Generation and Evolution in Self-Evolving Agents](http://arxiv.org/abs/2608.30429v1) | Doyun Kim, Chanwoo Kim, Sugyeong Eo et al. | LLM-based agent systems increasingly adopt skill-based architectures to reduce repetitive reasoning costs and improve stable, efficient task execution. |
...
|-------|---------|------|
| [RingMoClaw: An Experience-Inspired Multi-Agent Framework for Self-Evolving Research in Remote Sensing](http://arxiv.org/abs/2609.00814v1) | Kaiyue Kang, Qixuan He, Peijin Wang et al. | Remote sensing visual models have continuously advanced various interpretation tasks. However, the research process behind model improvement still heavily relies on manual expertise, requiring exte... |
| [Jailbreaking Text-to-Image Models Through Cracks: Navigating Heterogeneous Safety Filters via Multi-Agent Debate](http://arxiv.org/abs/2609.01168v1) | Kaiyan Wen, Shijie Zhang, Lu Yu et al. | Text-to-image (T2I) models remain vulnerable to jailbreak attacks that elicit Not-Safe-For-Work (NSFW) content, despite increasingly being guarded by heterogeneous, multi-layer safety stacks combin... |
| [CM2: Multimodal Cultural Reasoning via an Integrated Multi-Agent Framework](http://arxiv.org/abs/2608.30498v1) | Qi Li, Zhaojie Kang, Yingjie He et al. | Multimodal Large Language Models (MLLMs) have shown remarkable success in STEM domains, where progress is often driven by vertical, step-by-step deduction under relatively stable symbol systems. |
| [FRAMEWORKERS: A Dynamic Multi-Agent Framework for AI-Generated Video Production](http://arxiv.org/abs/2608.29814v1) | Zhendong Li, Lei Sun, Letian Shi et al. | Modern video generators excel at synthesizing individual clips, but complete video production requires coordinating a long sequence of interdependent creative steps, including scripting, storyboard... |
...
| [What Does an Agentic Software Engineering Benchmark Measure? Profiling Task Demands and Agent Behaviour Beyond What Category Labels Reveal](http://arxiv.org/abs/2609.01271v1) | Radin Shayanfar, Keheliya Gallaba, Ahmed E. Hassan | Agentic software engineering benchmarks are typically summarized by nominal category labels such as "bug fix" or "feature implementation," yet benchmarks carrying the same label are built through v... |
| [Toward Workflow-Aware Benchmarking for Healthcare NLP Agents](http://arxiv.org/abs/2609.00296v1) | Junyi Yao, Baichuan Li, Zihao Zheng et al. | Large language model (LLM) agents are increasingly proposed for healthcare tasks such as clinical documentation, evidence retrieval, patient messaging, and care coordination. |
| [GPAgentBench-2K: Benchmarking Large Language Model Agents in Complex Clinical Action Space](http://arxiv.org/abs/2608.30188v1) | Boqi Chen, Xudong Liu, Yunke Ao et al. | Large Language Models (LLMs) show great potential as clinical agents, yet existing benchmarks reduce clinical workflows to static predictions or unconstrained Markov Decision Processes (MDPs) with ... |
| [You Know What I Mean: A Benchmark for Agentic Conversational Reference Grounding](http://arxiv.org/abs/2608.29834v1) | Karen Fuchs, Uri Katz, Yoav Goldberg | Collaborative conversations frequently contain references whose targets are indirect rather than named: resolving "this looks like the fix discussed yesterday" requires combining conversational con... |
...
| Title | Authors | TLDR |
|-------|---------|------|
| [Will the User Ever Know? Covert Indirect Prompt Injection on Tool-Using LLM Agents](http://arxiv.org/abs/2608.30362v1) | Yunseok Lee, Yunji Kim, Woojin Lee | As LLM agents take real-world actions through tools, indirect prompt injection (IPI) has emerged as a serious threat. |
| [E-Commerce Bench: Evaluating LLM Agents on Long-Horizon Autonomous Business Operation](http://arxiv.org/abs/2608.30730v1) | Wei Fan, Xinjie Shen, Xudong Guo et al. | Long-horizon agentic tasks go beyond chaining short tasks over more interaction turns. Their evolving dynamic environments and long-range dependencies require Large Language Models (LLMs) to contin... |
| [EvoSkill Injection: Red-Teaming Autonomous Skill Generation and Evolution in Self-Evolving Agents](http://arxiv.org/abs/2608.30429v1) | Doyun Kim, Chanwoo Kim, Sugyeong Eo et al. | LLM-based agent systems increasingly adopt skill-based architectures to reduce repetitive reasoning costs and improve stable, efficient task execution. |
...
|-------|---------|------|
| [CM2: Multimodal Cultural Reasoning via an Integrated Multi-Agent Framework](http://arxiv.org/abs/2608.30498v1) | Qi Li, Zhaojie Kang, Yingjie He et al. | Multimodal Large Language Models (MLLMs) have shown remarkable success in STEM domains, where progress is often driven by vertical, step-by-step deduction under relatively stable symbol systems. |
| [AgenticRag-R1: Agentic Reinforcement Learning with Stack Memory for Multi-Step Reasoning, Retrieval and Memorizing](http://arxiv.org/abs/2608.29622v1) | Xinke Jiang, Yue Fang, Zhibang Yang et al. | Retrieval-Augmented Generation (RAG) improves the factuality of large language models (LLMs), yet existing RAG systems often struggle with complex, multi-step reasoning that requires adaptive retri... |
| [FRAMEWORKERS: A Dynamic Multi-Agent Framework for AI-Generated Video Production](http://arxiv.org/abs/2608.29814v1) | Zhendong Li, Lei Sun, Letian Shi et al. | Modern video generators excel at synthesizing individual clips, but complete video production requires coordinating a long sequence of interdependent creative steps, including scripting, storyboard... |
| [SIC-Agents: Benchmarking and Building an Adaptive Simulator for Pediatric Serious Illness Communication Training](http://arxiv.org/abs/2608.29481v1) | Zihan Wang, Anita Marie Slominska, Rennie Bimman et al. | Pediatric serious illness communication (SIC) is critically important, yet scalable communication training for clinicians remains limited. |

#### 📊 Computational Science of Science

| Title | Authors | TLDR |
|-------|---------|------|
| [LLMs Interpret, Embeddings Organize, Graphs Emerge: Agent-Driven Compilation of Scientific Knowledge](http://arxiv.org/abs/2608.29612v1) | Shi-Ju Ran, Kun Zhang, Xi Wu et al. | Sustained scientific work requires a knowledge substrate that carries interpretation across tasks and preserves paths to source evidence. |

#### 🛠️ Benchmarks & Evaluation for Research Agents

| Title | Authors | TLDR |
|-------|---------|------|
| [Ontology-Guided Multi-Agent Extraction of Evaluation Objects from Academic Review Texts: Evidence from Chinese Library and Information Science](http://arxiv.org/abs/2608.29526v1) | Haolin Chen, Hongyi Dong, Yu Zhu et al. | Academic reviews, scholarly commentaries, and book reviews serve as sources of evaluative statements about theories, methods, literature, institutions, and policies, providing valuable evidence for... |
| [Evaluating a 4B open-weights local LLM for agentic DFT workflows: a literature reproducibility audit](http://arxiv.org/abs/2608.29665v1) | Shambhu Bhandari Sharma | Agentic workflows in materials science relying on hosted commercial models face severe reproducibility, economic, and data-privacy constraints. |
| [Ideation Arena: Evaluating LLM Generated Research Ideas with Battle-style Human Expert Assessment](http://arxiv.org/abs/2608.29696v1) | Zhiyu Chen, Keyu Zhao, Jigao Fu et al. | Evaluating research ideas generated by LLMs is difficult because their scientific value cannot be fully determined by objective criteria, and no single reference answer specifies what counts as a g... |
| [GPAgentBench-2K: Benchmarking Large Language Model Agents in Complex Clinical Action Space](http://arxiv.org/abs/2608.30188v1) | Boqi Chen, Xudong Liu, Yunke Ao et al. | Large Language Models (LLMs) show great potential as clinical agents, yet existing benchmarks reduce clinical workflows to static predictions or unconstrained Markov Decision Processes (MDPs) with ... |
| [You Know What I Mean: A Benchmark for Agentic Conversational Reference Grounding](http://arxiv.org/abs/2608.29834v1) | Karen Fuchs, Uri Katz, Yoav Goldberg | Collaborative conversations frequently contain references whose targets are indirect rather than named: resolving "this looks like the fix discussed yesterday" requires combining conversational con... |
...
| Title | Authors | TLDR |
|-------|---------|------|
| [OmniScientist: An Omni-Modal Omni-Discipline AI Scientist](http://arxiv.org/abs/2608.13558v1) | Bobo Li, Hao Fei, Tianjie Ju et al. | Recent advances in foundation models have enabled AI scientists to automate increasingly complete research workflows, from hypothesis generation and code execution to manuscript preparation. |
| [Training AI Scientists to Replicate Research](http://arxiv.org/abs/2608.13331v1) | Damon Falck, Samer Sabri, Anja Surina et al. | The replicability of papers is a cornerstone of scientific knowledge, ensuring the reliability of existing results and providing a base for further experiments. |

#### 🧠 Multi-Agent Scientific Collaboration

| Title | Authors | TLDR |
|-------|---------|------|
| [Reconcile Once, Write Anytime: A Trust-Tiered Librarian and a Multi-Agent Writer for Drift-Free, Point-in-Time Research](http://arxiv.org/abs/2608.12984v1) | Xing Zhang, Yanwei Cui, Guanghui Wang et al. | Long-form research reports generated by large language models drift, contradict themselves, and lose provenance: the same metric appears with different values, and rumor is quoted as confidently as... |
| [MARC v1: An Open-Source Multi-Agent Framework for Clinical AI Reasoning and Coordination](http://arxiv.org/abs/2608.13476v1) | Saisha Shetty, Satvik Tripathi, Austin Lin et al. | We present Multi-Agent Reasoning and Coordination (MARC), an open-source framework that replaces monolithic LLM prompting with deterministic multi-agent orchestration for clinical reasoning. |
...
| Title | Authors | TLDR |
|-------|---------|------|
| [Spatial Memory Agent: Experience-Grounded Procedure Memory for Spatial Intelligence](http://arxiv.org/abs/2608.12743v1) | Haokai Zhang, Yuhang Ding, Yunshu Zhou et al. | Spatial intelligence is becoming a foundation for embodied agents, robotic planning, and multimodal assistants. |
| [OmniScientist: An Omni-Modal Omni-Discipline AI Scientist](http://arxiv.org/abs/2608.13558v1) | Bobo Li, Hao Fei, Tianjie Ju et al. | Recent advances in foundation models have enabled AI scientists to automate increasingly complete research workflows, from hypothesis generation and code execution to manuscript preparation. |
| [Training AI Scientists to Replicate Research](http://arxiv.org/abs/2608.13331v1) | Damon Falck, Samer Sabri, Anja Surina et al. | The replicability of papers is a cornerstone of scientific knowledge, ensuring the reliability of existing results and providing a base for further experiments. |
...
| [Reconcile Once, Write Anytime: A Trust-Tiered Librarian and a Multi-Agent Writer for Drift-Free, Point-in-Time Research](http://arxiv.org/abs/2608.12984v1) | Xing Zhang, Yanwei Cui, Guanghui Wang et al. | Long-form research reports generated by large language models drift, contradict themselves, and lose provenance: the same metric appears with different values, and rumor is quoted as confidently as... |
| [MARC v1: An Open-Source Multi-Agent Framework for Clinical AI Reasoning and Coordination](http://arxiv.org/abs/2608.13476v1) | Saisha Shetty, Satvik Tripathi, Austin Lin et al. | We present Multi-Agent Reasoning and Coordination (MARC), an open-source framework that replaces monolithic LLM prompting with deterministic multi-agent orchestration for clinical reasoning. |
| [ReflectFact: Self-Reflective Agents for Improving Comprehension and Reasoning in Multi-Hop Fact Verification](http://arxiv.org/abs/2608.12877v1) | Runze Zhao, Zixin Tang, Xiaoshuai Hao et al. | Multi-hop fact verification, which verifies claims by reasoning over multiple pieces of evidence, is critical for combating misinformation on social media yet remains highly challenging. |
| [Lines and Ladders: A Context-Aware Multi-Agent Framework for Large-Scale Retail Price Taxonomy](http://arxiv.org/abs/2608.12674v1) | Ravi Teja Chunduri, Srikaran Reddy Boya, Deep Narayan Mishra et al. | Maintaining price consistency and executing an Every Day Low Price strategy is critical for global retailers. |

#### 🛠️ Benchmarks & Evaluation for Research Agents

| Title | Authors | TLDR |
|-------|---------|------|
| [SteerBench-Work: A Benchmark for Agent Steering at Action Boundaries](http://arxiv.org/abs/2608.12654v1) | Oguz Serdar, Cuneyt Mertayak | Long-running LLM agents act through tools, and a single step can send an email, merge a pull request, or wire a payment. |
...
| Title | Authors | TLDR |
|-------|---------|------|
| [Actions Speak Louder than Words: Measuring Cross-Lingual Policy Retention in Tool-Using Agents](http://arxiv.org/abs/2608.11110v2) | Sourabrata Mukherjee, Kalika Bali, Sunayana Sitaram | When a tool-using agent is given the same task in a different language, does it still take the same steps? |
...
| [MBA: Multimodal Benchmark and Agents for Real-World Business Ideation](http://arxiv.org/abs/2608.11616v2) | Hojun Choi, Jaeyo Shin, Suin Lee et al. | Agentic systems powered by large language models (LLMs) have opened new opportunities for business ideation. |
...
| Title | Authors | TLDR |
|-------|---------|------|
| [Fisher-R1: Training LLM Agents for Reliable Hypothesis Testing](http://arxiv.org/abs/2608.07437v1) | Jiacheng Miao, Jin Mu, Guanhua Chen et al. | Reliable hypothesis testing is the foundation of many empirical scientific claims. Large language model (LLM) agents are increasingly used to automate this process, as they can inspect datasets, ge... |
...
| Title | Authors | TLDR |
|-------|---------|------|
| [Where Reasoning Diverges: Localized Multi-Agent Debate for Multi-Hop Question Answering](http://arxiv.org/abs/2608.01463v2) | Weijun Gao, Xiang Ding, Haoyang Liu et al. | Multi-agent debate commonly exchanges complete rationales even when disagreements concern only a few intermediate claims. |
| [Shared Prefixes, Better Credit: Adaptive Routing for Multi-Agent Reasoning](http://arxiv.org/abs/2608.02291v1) | Yiqing Liu, Zihao Wang, Hantao Yao et al. | Multi-agent reasoning (MAR) improves reasoning reliability through iterative solution exchange and refinement. |
...
| Title | Authors | TLDR |
|-------|---------|------|
| [Large Language Models (LLMs) and Generative AI in Cybersecurity and Privacy: A Survey of Dual-Use Risks, AI-Generated Malware, Explainability, and Defensive Strategies](http://arxiv.org/abs/2607.06963v1) | Kiarash Ahi, Saeed Valizadeh | Large Language Models (LLMs) and generative AI (GenAI) systems, such as ChatGPT, Claude, Gemini, LLaMA, Copilot, Stable Diffusion by OpenAI, Anthropic, Google, Meta, Microsoft, Stability AI, respec... |
| [Beyond Attack-Success Rate: Action-Graded Severity Scale for Tool-Using AI Agents](http://arxiv.org/abs/2607.07474v1) | Harry Owiredu-Ashley | Agentic red-teaming benchmarks report whether an injected agent was compromised as a single bit: the attack succeeded, or it did not. |
| [End-to-End LLM Flight Planning with RAG-based Memory and Multi-modal Coach Agent](http://arxiv.org/abs/2607.06964v1) | Amin Tabrizian, Arsyi Aziz, Aarifah Ullah et al. | Bridging the gap between human pilot intent and autonomous flight operation is critical for real-world electric vertical takeoff and landing (eVTOL) aircraft deployment. |
...
| [PHREEQC-MCQ-200: A Diagnostic Benchmark for Tool-Augmented Scientific Simulator Agents](http://arxiv.org/abs/2607.00436v1) | Ke Zhang, Sahchit Chundur, Mohammad Javad Qomi et al. | Large language model agents are increasingly connected to scientific software, yet it remains unclear when tool access makes scientific computation more reliable rather than merely more complex. |
| [Are Performance-Optimization Benchmarks Reliably Measuring Coding Agents?](http://arxiv.org/abs/2607.01211v1) | Zhi Chen, Zhensu Sun, Yuling Shi et al. | Repository-level performance-optimization benchmarks such as GSO, SWE-Perf and SWE-fficiency evaluate coding agents by applying patches to real repositories and comparing runtime against unoptimize... |
| [MemSyco-Bench: Benchmarking Sycophancy in Agent Memory](http://arxiv.org/abs/2607.01071v1) | Zhishang Xiang, Zerui Chen, Yunbo Tang et al. | Memory has emerged as a cornerstone of modern LLM-based agents, supporting their evolution from single-turn assistants to long-term collaborators. |
| [AGI Maze as a Benchmark Framework for World-Modeling Agents](http://arxiv.org/abs/2607.00627v1) | Alexey Potapov | Large language models (LLMs) are powerful pattern-completion systems, but their default operating mode - predicting the next token from a static context - does not reliably produce persistent, mani... |
| [EgoGapBench: Benchmarking Egocentric Action Selection in Multi-Agent Scenes](http://arxiv.org/abs/2607.00547v1) | Jihyeok Jung, Jeewu Lee, Sanghyeop Kim et al. | Existing egocentric benchmarks have primarily constructed the egocentric setting from first-person-view data, which makes it difficult to evaluate egocentric perspective itself in isolation. |
| [HealthAgentBench: A Unified Benchmark Suite of Realistic Agentic Healthcare Environments for Challenging Frontier AI Agents](http://arxiv.org/abs/2606.31179v1) | Qianchu Liu, Sheng Zhang, Guanghui Qin et al. | As AI agents become increasingly capable of complex, long-horizon reasoning, rigorous and holistic evaluation is essential for measuring progress toward real-world healthcare applications. |
| [ClawArena-Team: Benchmarking Subagent Orchestration and Dynamic Workflows in Language-Model Agents](http://arxiv.org/abs/2606.31174v1) | Kaiwen Xiong, Haonian Ji, Shi Qiu et al. | Production large language-model (LLM) agents are increasingly deployed not as lone problem-solvers but as managers: a main model creates specialized subagents, delegates work, and orchestrates thei... |
| [PPT-Eval: A Benchmark for Computer-Use Agents on PowerPoint Tasks](http://arxiv.org/abs/2606.31154v1) | Apurva Gandhi, Vishwas Suryanarayanan, Raja Hasnain Anwar et al. | Creating and editing slides is a rich, multimodal activity that is ubiquitous in professional and educational settings, making it an ideal testbed for real-world computer-use agents. |
...
| Title | Authors | TLDR |
|-------|---------|------|
| [From Parasocial Scripts to Dyadic Persistence in Autonomous AI-Agent Communities](http://arxiv.org/abs/2606.17174v1) | Mohammadsadegh Abolhasani, Hamid Reza Firoozfar, Reza Mousavi et al. | While parasocial interactions (PSIs) and parasocial relationships (PSRs) have been studied in conventional media settings, we investigate whether PSI- (colloquial) relational cues also exist in onl... |
...
| [Deep Research in Physical Sciences: A Multi-Agent Framework and Comprehensive Benchmark](http://arxiv.org/abs/2606.18648v1) | Yigeng Jiang, Tengchao Yang, Taoyong Cui et al. | Deep research agents are Large Language Model (LLM)-based systems designed for autonomous, multi-step scientific reasoning, and they hold immense potential for accelerating research in the physical... |
| [LegalHalluLens: Typed Hallucination Auditing and Calibrated Multi-Agent Debate for Trustworthy Legal AI](http://arxiv.org/abs/2606.18021v1) | Lalit Yadav, Akshaj Gurugubelli | AI systems deployed in legal workflows hallucinate at rates that aggregate metrics report at ~52%, but this average conceals where errors concentrate and in which direction they run, leaving compli... |
| [Agentra: A Supervisable Multi-Agent Framework for Enterprise Intrusion Response](http://arxiv.org/abs/2606.18325v1) | Raj Patel, Shaswata Mitra, Michele Guida et al. | Enterprise intrusion response still depends on static playbooks and analyst-driven triage, creating delay between alert generation and containment. |
| [Trustworthy Self-Composable Big-Data-as-a-Service: An LLM-Orchestrated Multi-Agent Framework for Automated Data Engineering, AutoML, MLOps Deployment, and Drift-Aware Lifecycle Optimization](http://arxiv.org/abs/2606.17915v1) | Aueaphum Aueawatthanaphisut, Badri Raj Lamichhane | Big-Data-as-a-Service (BDaaS) platforms require re liable automation across data ingestion, cleaning, feature engi neering, model development, deployment, and post-deployment monitoring. |
| [Divide, Deliberate, Decide: A Multi-Agent Framework for Fine-Grained Egocentric Action Recognition](http://arxiv.org/abs/2606.17627v1) | Alessandro Sottovia, Alessandro Torcinovich, Oswald Lanz | Fine-grained action recognition in egocentric video is challenging for Vision-Language Models (VLMs): actions often differ only in small visual cues, and a single model tends to be biased toward a ... |
...
| Title | Authors | TLDR |
|-------|---------|------|
| [LabOSBench: Benchmarking Computer Use Agents for Scientific Instrument Control](http://arxiv.org/abs/2606.16802v1) | Anqi Zou, Han Deng, Chengyu Zhang et al. | Current computer-use benchmarks primarily focus on software operation tasks in virtualized systems, whereas scientific instrumentation scenarios require coordinated control over complex interfaces,... |
| [WorldLines: Benchmarking and Modeling Long-Horizon Stateful Embodied Agents](http://arxiv.org/abs/2606.18847v1) | Yehang Zhang, Jianchong Su, Haojian Huang et al. | To assist humans over extended periods in real homes, embodied agents must remember user routines, world states, and past interactions. |
| [Your AI Travel Agent Would Book You a Bullfight: An Agentic Benchmark for Implicit Animal Welfare in Frontier AI Models](http://arxiv.org/abs/2606.18142v2) | Jasmine Brazilek, Joel Christoph, Miles Tidmarsh et al. | AI agents are moving from advisors to actors, booking travel, planning menus, and running procurement on behalf of users. |
| [Position: Coding Benchmarks Are Misaligned with Agentic Software Engineering](http://arxiv.org/abs/2606.17799v1) | Maria I. Gorinova, Macey Baker, Amy Heineike et al. | Coding agents have become a major mode of software engineering, but the benchmarks we use to compare them were designed in a pre-agent era: they collapse model, harness, and environment into a sing... |
| [EComAgentBench: Benchmarking Shopping Agents on Long-Horizon Tasks with Distributed Hidden Intent](http://arxiv.org/abs/2606.17698v1) | Zeyao Du, Tong Li, Haibo Zhang | As LLM-based shopping agents enter production, existing benchmarks fail to capture how a shopper's requirements arrive: stated implicitly in the query, recorded in a profile, or revealed only when ... |
| [Can LLMs Be CEOs? Benchmarking Strategic Resource Reallocation with Multi-Role Agent Simulation](http://arxiv.org/abs/2606.17459v1) | Yuyang Dai, Xueqing Peng, Lingfei Qian et al. | Evaluating the decision-making capabilities of large language models (LLMs) is a growing research priority, yet existing benchmarks focus on isolated cognitive tasks such as reasoning, knowledge re... |
| [MapSatisfyBench: Benchmarking Satisfaction-Aware Map Agents through Behavior-Grounded Implicit Decision Factors](http://arxiv.org/abs/2606.17453v2) | Lubin Bai, Mengyu Cao, Sixue Wang et al. | Large language model agents are increasingly integrated into map services. Since map services are embedded in everyday-life scenarios rather than professional task settings, users often express the... |
| [CoffeeBench: Benchmarking Long-Horizon LLM Agents in Heterogeneous Multi-Agent Economies](http://arxiv.org/abs/2606.16613v1) | Issa Sugiura, Daichi Hattori, Kazuo Araragi et al. | As LLM agents become capable of increasingly long-horizon tasks, evaluating their performance in economic systems is becoming increasingly important. |
| [GateMem: Benchmarking Memory Governance in Multi-Principal Shared-Memory Agents](http://arxiv.org/abs/2606.18829v1) | Zhe Ren, Yibo Yang, Yimeng Chen et al. | Memory benchmarks for LLM agents largely assume single-user settings, leaving shared assistants for hospitals, workplaces, campuses, and households understudied. |
| [Benchmarking LLM Agents on Meta-Analysis Articles from Nature Portfolio](http://arxiv.org/abs/2606.17041v2) | Anzhe Xie, Weihang Su, Yujia Zhou et al. | Meta-analysis is a demanding form of evidence synthesis that combines literature retrieval, PI/ECO-guided study selection, and statistical aggregation. |
| [MyPCBench: A Benchmark for Personally Intelligent Computer-Use Agents](http://arxiv.org/abs/2606.16748v1) | Lawrence Keunho Jang, Andrew Keunwoo Jang, Jing Yu Koh et al. | Current benchmarks for computer-use agents evaluate models in impersonal environments. This leaves a gap between evaluation and deployment where personal assistants are expected to work across a us... |
| [FraudSMSWalker: Benchmarking Agentic Large Language Models for SMS-to-Webpage Fraud Detection](http://arxiv.org/abs/2606.16659v1) | Y. H. Zhou, Z. M. Ma, Y. J. Zhou et al. | SMS fraud is increasingly cross-channel: a message directs the user to a webpage, and the final risk depends on how the SMS claim aligns with the page content and requested user action. |
...
| [SoundnessBench: Can Your AI Scientist Really Tell Good Research Ideas from Bad Ones?](http://arxiv.org/abs/2605.30329v1) | Sy-Tuyen Ho, Minghui Liu, Huy Nghiem et al. | Autonomous AI research agents aim to accelerate scientific discovery by automating the research pipeline, from hypothesis generation to peer review. |
...
| Title | Authors | TLDR |
|-------|---------|------|
| [Cyber Defense Benchmark: Agentic Threat Hunting Evaluation for LLMs in SecOps](http://arxiv.org/abs/2604.19533v2) | Alankrit Chona, Igor Kozlov, Ambuj Kumar | We introduce the Cyber Defense Benchmark, a benchmark for measuring how well large language model (LLM) agents perform the core SOC analyst task of threat hunting: given a database of raw Windows e... |
...
| Year | Title | TLDR |
|------|-------|------|
| 2023 | [ChemCrow: Augmenting large-language models with chemistry tools](https://arxiv.org/abs/2304.05376) | An LLM agent equipped with 17 chemistry tools that can plan and execute chemical research tasks like drug discovery and materials design autonomously. |
| 2024 | [The AI Scientist: Towards Fully Automated Open-Ended Scientific Discovery](https://arxiv.org/abs/2408.06292) | First end-to-end system where AI agents independently generate research ideas, run experiments, write papers, and conduct peer review. |
| 2024 | [SciAgents: Automating scientific discovery through multi-agent intelligent graph reasoning](https://arxiv.org/abs/2409.05556) | Multi-agent system using knowledge graphs to autonomously generate and validate scientific hypotheses across domains. |
| 2023 | [Voyager: An Open-Ended Embodied Agent with Large Language Models](https://arxiv.org/abs/2305.16291) | First LLM-powered lifelong learning agent that builds a reusable skill library and continuously explores — a paradigm for open-ended discovery. |
| 2024 | [OS-Copilot: Towards Generalist Computer Agents with Self-Improvement](https://arxiv.org/abs/2402.07456) | A framework for building generalist agents that interact with any OS element and self-improve through experience — foundational for research automation. |
| 2024 | [SWE-agent: Agent-Computer Interfaces Enable Automated Software Engineering](https://arxiv.org/abs/2405.15793) | Designs agent-computer interfaces that let LLMs autonomously fix real GitHub issues — a model for agents that interact with research codebases. |
| 2025 | [Agent S2: An Agentic System for Compositional Generalization in Computer Use](https://arxiv.org/abs/2504.00906) | A compositional agent system that generalizes across computer tasks through hierarchical planning — applicable to complex scientific workflows. |

### 📖 Research Workflow Agents

| Year | Title | TLDR |
|------|-------|------|
| 2023 | [HuggingGPT: Solving AI Tasks with ChatGPT and its Friends in Hugging Face](https://arxiv.org/abs/2303.17580) | Uses ChatGPT as a controller to orchestrate existing AI models for complex tasks — a blueprint for agents that chain research tools. |
| 2023 | [Reflexion: Language Agents with Verbal Reinforcement Learning](https://arxiv.org/abs/2303.11366) | Agents learn from mistakes via natural language self-reflection — key for iterative research workflows where agents refine hypotheses. |
| 2023 | [Can Large Language Models Provide Useful Feedback on Research Papers?](https://arxiv.org/abs/2310.01783) | Evaluates GPT-4's peer review-like feedback, finding substantial overlap with human reviewers — agents entering the review process. |
| 2023 | [Large Language Models for Science: A Survey](https://arxiv.org/abs/2312.07622) | Comprehensive survey of how LLMs transform scientific workflows — from literature analysis to hypothesis generation and experiment design. |
| 2024 | [AutoGen: Enabling Next-Gen LLM Applications via Multi-Agent Conversation](https://arxiv.org/abs/2308.08155) | A framework for multi-agent conversations — applicable to research brainstorming, collaborative writing, and iterative analysis. |
| 2024 | [OpenAgents: An Open Platform for Language Agents in the Wild](https://arxiv.org/abs/2310.10634) | Deploys three real-world agents (data, plugin, web) bridging agent research and everyday use — including data analysis for researchers. |
| 2024 | [ResearchAgent: Iterative Research Idea Generation over Scientific Literature](https://arxiv.org/abs/2404.07738) | An agent that iteratively reads papers, identifies gaps, and generates novel research ideas with supporting evidence. |

### 🧠 Multi-Agent Scientific Collaboration

| Year | Title | TLDR |
|------|-------|------|
| 2023 | [Generative Agents: Interactive Simulacra of Human Behavior](https://arxiv.org/abs/2304.03442) | 25 AI agents with memory and reflection exhibit believable social behaviors — a foundation for simulating scientific communities. |
| 2023 | [ChatDev: Communicative Agents for Software Development](https://arxiv.org/abs/2307.07924) | Multi-agent chat chain with specialized roles (CEO, CTO, programmer) — a template for multi-agent research teams (PI, reviewer, analyst). |
| 2023 | [MetaGPT: Meta Programming for Multi-Agent Collaboration](https://arxiv.org/abs/2308.00352) | Encodes SOPs into multi-agent workflows with structured outputs — applicable to research pipelines with defined methodology steps. |
| 2024 | [More Agents Is All You Need](https://arxiv.org/abs/2402.05120) | Simply sampling multiple agents with majority voting improves performance — relevant to ensemble approaches in scientific reasoning. |
| 2024 | [AgentGym: Evolving LLM-based Agents across Diverse Environments](https://arxiv.org/abs/2406.04151) | Training generally-capable agents across diverse environments — a step toward agents that adapt across scientific domains. |
| 2024 | [Debating with More Persuasive LLMs Leads to More Truthful Answers](https://arxiv.org/abs/2402.06782) | Multi-agent debate improves factual accuracy — directly applicable to scientific peer review and hypothesis validation. |

### 📊 Computational Science of Science

| Year | Title | TLDR |
|------|-------|------|
| 2018 | [Science of Science (Dashun Wang et al.)](https://doi.org/10.1126/science.aao0185) | Landmark review establishing the field — universal patterns in how scientists discover, collaborate, and build careers. |
| 2019 | [The Science of Science: From the Perspective of Complex Systems](https://doi.org/10.1016/j.physrep.2017.10.001) | Frames the scientific enterprise as a complex system — collaboration networks, citation dynamics, knowledge diffusion. |
| 2019 | [Measuring the Evolution of a Scientific Field through Citation Frames](https://arxiv.org/abs/1903.09951) | Citation intent classification to track how the framing and role of cited works evolve over time. |
| 2021 | [Quantifying the Dynamics of Failure Across Science, Startups, and Security](https://doi.org/10.1038/s41586-019-1725-y) | Discovers a universal pattern of early failure preceding eventual success across NIH grants, startups, and other domains. |
| 2015 | [Prediction of Highly Cited Papers](https://doi.org/10.1016/j.joi.2016.05.002) | Features and models to predict which papers become highly cited — revealing early signals of research impact. |
| 2023 | [Papers with Code: Tracking ML Progress through Benchmarks](https://arxiv.org/abs/2304.00720) | Analyzes how open benchmarks and code sharing accelerate ML research — a case study in research dynamics. |
| 2024 | [The Transformation of Science and its Societal Impact](https://arxiv.org/abs/2403.19748) | Examines how AI is reshaping the scientific method itself and what it means for the future of research. |

### 🛠️ Benchmarks & Evaluation for Research Agents

| Year | Title | TLDR |
|------|-------|------|
| 2024 | [ScienceAgentBench: Toward Rigorous Assessment of Language Agents for Data-Driven Scientific Discovery](https://arxiv.org/abs/2410.05080) | A benchmark for evaluating AI agents on real scientific data analysis tasks across multiple disciplines. |
| 2024 | [MLAgentBench: Evaluating Language Agents on Machine Learning Experimentation](https://arxiv.org/abs/2310.03302) | Benchmarks agents on end-to-end ML research tasks — from data exploration to model training and reporting. |
| 2024 | [CORE-Bench: Fostering the Credibility of Published Research Through a Computational Reproducibility Agent Benchmark](https://arxiv.org/abs/2409.11353) | Evaluates agents on reproducing computational results from published papers — connecting agent capability to scientific credibility. |
| 2024 | [BioDiscoveryAgent: An AI Agent for Automating Biomedical Experiments](https://arxiv.org/abs/2405.17631) | An agent for designing and running biomedical experiments, benchmarked against human expert performance. |
...
2. The script queries ArXiv for recent papers at the intersection of AI agents and science of science
...
Found a great paper at the intersection of agents and science? Open an issue or PR!
